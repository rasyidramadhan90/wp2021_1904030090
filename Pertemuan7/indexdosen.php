...
$camaba = query("SELECT * FROM tabel_dosen")
 ?>
            ...
            <table class="table table-striped">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $cmb ['NO']; ?></td>
                  <td><?php echo $cmb ['NIDN']; ?></td>
                  <td><?php echo $cmb ['NAMA']; ?></td>
                  <td><?php echo $cmb ['Email']; ?></td>
                  <td><?php echo $cmb ['Aksi']; ?></td>
                  <td><img src= "Image/<?php echo $cmb['foto'];?>"width="100px"></td>
                  <td><a href="detail.php?nidn=<?= $cmb['nidn']?>" class="btn btn-warning" role= "button">detail</a><td>
