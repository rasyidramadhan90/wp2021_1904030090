...
$camaba = query("SELECT * FROM tabel_anggota WHERE id_anggota=$id_anggota");
//var_dump($camaba);
    ...
    <body id="page-top">
      ...
      <ul class="list-group">
        ...
        <li class="list-group-item"><img src="Image/<?= $camaba['foto']; ?> "width="120px"></li>
          <a href="editanggota.php?id_anggota=<?= $camaba['id_anggota']; ?>" class="btn btn-warning" role="button">Edit</a> |
